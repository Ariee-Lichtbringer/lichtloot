...
local function build()
 ...
 check(p,'Felder über Addon-Fenstern',14,-268,'frontStrata','An: die Heilfelder liegen über anderen Addon-Fenstern (z. B. dem GuildLoot-Buffpanel), damit Klicks immer die Felder treffen. Wirkt außerhalb des Kampfes.',function() GH.ApplyStrata() end)
