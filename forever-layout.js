...
window.renderForeverLayoutEditor=(host,data,api,onSaved)=>{
 ...
 const discord=group('2. Discord-Bot und Channels');const bot=el('a','P0-Anmelder-Bot einladen','primary');bot.href='https://discord.com/oauth2/authorize?client_id=1527793332346945537&permissions=2147560448&scope=bot%20applications.commands';bot.target='_blank';bot.rel='noopener';discord.append(bot,el('p','Im gewünschten Channel /forever_verbinden mit eurem Gildenkürzel und Leitungscode verwenden. Dafür ist „Server verwalten“ erforderlich.'));
