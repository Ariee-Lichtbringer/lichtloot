...
function mount(host,options){
 if(!host)return;
 host.innerHTML='<details style="margin:14px 0;padding:0 16px;border:1px solid #52677d;border-radius:12px"><summary style="cursor:pointer;padding:14px 0;font-weight:700;list-style:none;display:flex;align-items:center;gap:8px"><span aria-hidden="true">▸</span>GuildLoot-Addon · Raid importieren <span style="font-weight:400;opacity:.7;font-size:.9em">(zum Aufklappen klicken)</span></summary><div style="padding:0 0 16px"><p>Beute und Teilnahme aus dem Addon übernehmen. Erhaltene P0-Items werden gold markiert. Anschließend wie gewohnt „P0+ übertragen“ öffnen; dort wird die Teilnahme mit Warcraft Logs gegengeprüft.</p><label>Exportdatei auswählen <input data-file type="file" accept=".json,.txt,application/json,text/plain"></label><details style="margin:10px 0"><summary>Oder Exporttext einfügen</summary><textarea data-text rows="5" aria-label="Raid-Export aus dem Addon" style="box-sizing:border-box;width:100%;font:14px/1.5 monospace"></textarea></details><label>Mastercode oder Plündermeister-Passwort <input data-password type="password" autocomplete="current-password"></label><button type="button" data-import class="btn" style="margin:10px">Raid-Export übernehmen</button><div data-status role="status"></div></div></details>';
