(()=>{
 ...
 .armor-my-requests{margin-top:22px;border-top:1px solid #243448;padding-top:14px}.armor-my-requests h4{margin:0 0 10px}.armor-my-requests table{width:100%;border-collapse:collapse;font-size:14px}.armor-my-requests th,.armor-my-requests td{padding:8px 6px;border-bottom:1px solid #243448;text-align:left;vertical-align:top}.armor-my-requests th{color:#a3b6cc;font-weight:600}.armor-my-requests small{display:block;margin-top:8px}.armor-status{display:inline-block;padding:2px 9px;border-radius:999px;font-size:12px;font-weight:700}.armor-status-waiting,.armor-status-pending{background:#4a3a12;color:#fbbf24}.armor-status-approved{background:#123f2a;color:#4ade80}.armor-status-rejected{background:#4a1d1d;color:#f87171}
 ...
 window.GuildLootArmor={async open(root,context){
  ...
  try{
   ...
   const statusLabel=value=>value==='waiting'?'Warteschlange – derzeit nicht vorrätig':value==='approved'?'freigegeben':value==='rejected'?'abgelehnt':'offen';
