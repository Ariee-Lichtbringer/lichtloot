(() => {
  ...
  const names={windows:'GuildLoot-Sync-0.3.8-Windows-Setup.exe','mac-arm64':'GuildLoot-Sync-0.3.8-mac-Apple-Silicon.pkg','mac-x64':'GuildLoot-Sync-0.3.8-mac-Intel.pkg'};
