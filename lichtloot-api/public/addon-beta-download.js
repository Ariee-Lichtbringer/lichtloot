(() => {
  ...
  const names={windows:'GuildLoot-Sync-0.3.7-Windows-Setup.exe','mac-arm64':'GuildLoot-Sync-0.3.7-mac-Apple-Silicon.pkg','mac-x64':'GuildLoot-Sync-0.3.7-mac-Intel.pkg',addon:'GuildLootEra-0.21.2-beta.zip'};
