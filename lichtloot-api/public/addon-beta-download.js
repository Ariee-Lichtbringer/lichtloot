(() => {
  ...
  const names={windows:'GuildLoot-Sync-0.3.1-Windows-Setup.exe','mac-arm64':'GuildLoot-Sync-0.3.1-mac-Apple-Silicon.pkg','mac-x64':'GuildLoot-Sync-0.3.1-mac-Intel.pkg',addon:'GuildLootEra-0.20.2-beta.zip'};
