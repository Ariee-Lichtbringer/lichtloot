(() => {
  ...
  const names={windows:'GuildLoot-Sync-0.3.6-Windows-Setup.exe','mac-arm64':'GuildLoot-Sync-0.3.6-mac-Apple-Silicon.pkg','mac-x64':'GuildLoot-Sync-0.3.6-mac-Intel.pkg',addon:'GuildLootEra-0.21.1-beta.zip'};
