...
await review('rejected');assert.equal(notices.length,0,'Nur ablehnen bleibt ohne Nachricht');
...
console.log('PASS approval DM, rejection DM, explicit silent rejection, missing Discord link, mailbox fallback and no PIN disclosure.');
